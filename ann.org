...
class OCRNeuralNetwork:
    ...
    def back_propagate(self, input_data, data_label):
        ...
        errors = output_layer_activations - target_values
        # TODO: The multiplications below need to be dot products or elementwise. Think about which.
        rate_of_change_of_error_with_respect_to_final_weights = (
            (output_layer_activations - target_values)
        ...
        rate_of_change_of_error_with_respect_to_first_weights = (
            ...
            ,* self.sigmoid_prime(output_layer_pre_activations)
            ,* self.theta2
            ,* self.sigmoid_prime(hidden_layer_pre_activations)
            ,* input_data
        )
